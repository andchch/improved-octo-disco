...
namespace NoiseLib
{
    public class Mapping
    {
        ...
        public static void Map2D(MappingMode mappingMode, double[,] array, ImplicitModuleBase module,
            MappingRanges ranges, double z)
        {
            ...
            for (var y = 0; y < height; ++y)
            {
                ...
                switch (mappingMode)
                {
                    ...
                    case MappingMode.SeamlessXYZ:
                        ...
                        var nv = ranges.LoopZ0 + Math.Sin(xyzval * PI2) * dz / PI2;
            ...
            for (var y = 0; y < height; ++y)
            {
                ...
                switch (mappingMode)
                {
                    ...
                    case MappingMode.SeamlessXY:
                        ...
                        ny = ranges.LoopX0 + Math.Sin(p * PI2) * dx / PI2;
                        nz = ranges.LoopY0 + Math.Cos(q * PI2) * dy / PI2;
                        var nw = ranges.LoopY0 + Math.Sin(q * PI2) * dy / PI2;
                        val = module.Get(nx, ny, nz, nw);
                        break;
                }
            ...
            for (var z = 0; z < depth; ++z)
            {
                ...
                switch (mappingMode)
                {
                    ...
                    case MappingMode.SeamlessXYZ:
                        ...
                        var nv = ranges.LoopZ0 + Math.Sin(r * PI2) * dz / PI2;
                        val = module.Get(nx, ny, nz, nw, nu, nv);
                        break;
                }
