namespace NoiseLib.Implicit
{
    public sealed class ImplicitGradient : ImplicitModuleBase
    {
            ...
            double u0, double u1, double v0, double v1)
        {
            ...
            length4 = gradientX1 * gradientX1 + gradientY1 * gradientY1 + gradientZ1 * gradientZ1 +
                      gradientW1 * gradientW1;
            length6 = gradientX1 * gradientX1 + gradientY1 * gradientY1 + gradientZ1 * gradientZ1 +
                      gradientW1 * gradientW1 + gradientU1 * gradientU1 + gradientV1 * gradientV1;
        }
        ...
        public override double Get(double x, double y)
        {
            var dx = x - gradientX0;
            var dy = y - gradientY0;
            var dp = dx * gradientX1 + dy * gradientY1;
            dp /= length2;
            return dp;
        }
        ...
        public override double Get(double x, double y, double z)
        {
            ...
            var dy = y - gradientY0;
            var dz = z - gradientZ0;
            var dp = dx * gradientX1 + dy * gradientY1 + dz * gradientZ1;
            dp /= length3;
            return dp;
        }
        ...
        public override double Get(double x, double y, double z, double w)
        {
            ...
            var dz = z - gradientZ0;
            var dw = w - gradientW0;
            var dp = dx * gradientX1 + dy * gradientY1 + dz * gradientZ1 + dw * gradientW1;
            dp /= length4;
            return dp;
        }
        ...
        public override double Get(double x, double y, double z, double w, double u, double v)
        {
            ...
            var du = u - gradientU0;
            var dv = v - gradientV0;
            var dp = dx * gradientX1 + dy * gradientY1 + dz * gradientZ1 + dw * gradientW1 + du * gradientU1 +
                     dv * gradientV1;
            dp /= length6;
            return dp;
        }
