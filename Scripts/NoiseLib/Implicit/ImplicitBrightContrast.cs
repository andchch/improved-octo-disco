namespace NoiseLib.Implicit
{
    ...
    {
        public ImplicitBrightContrast(ImplicitModuleBase source, double brightness, double contrastThreshold,
        ...
        private ImplicitModuleBase Source { get; }

        private ImplicitModuleBase Brightness { get; }

        private ImplicitModuleBase ContrastThreshold { get; }

        private ImplicitModuleBase ContrastFactor { get; }
